...
export default function Navbar() {
  ...
  return (
    <nav className="fixed flex flex-col items-center justify-between px-5 py-7 h-[80%] top-5 left-4 text-white backdrop-blur-xl rounded-3xl z-20 max-sm:hidden">
      ...
      <button
        className="absolute -right-2 top-7 bg-blue-600 bg-opacity-40 border border-white rounded-full p-1"
      ...
      <ul
        className={`relative flex flex-col items-center gap-8 text-gray-100 ${
          expand && "!items-start"
        }`}>
        <li>
          <button className="flex items-center gap-2">
            ...
            />
            {expand && <span className="font-extrabold text-sm">LOJA PEGAZUS</span>}
          </button>
        </li>
        <li>
          <button className="flex items-center gap-2">
        ...
        <li>
          <button className="flex items-center gap-2">
            <Icon icon="ph:atom-light" width={24} />
        ...
        <li>
          <button className="flex items-center gap-2">
            ...
            {expand && <span className="text-xs">Meus pedidos</span>}
          </button>
        </li>
      </ul>
