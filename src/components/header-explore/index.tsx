...
export default function HeaderExplore() {
  return (
    <div className="flex items-center justify-between flex-wrap relative top-16 w-[85%] mx-auto text-white max-2xl:justify-center max-2xl:gap-12">
      {/* Buscas que cresceram */}
      <div className="relative group w-[22rem] h-[30rem] opacity-80 rounded-3xl cursor-pointer bg-blue-600 bg-opacity-60 backdrop-blur-3xl hover:opacity-100 hover:bg-opacity-80 duration-500 shadow-2xl">
      ...
      <div className="relative group w-[22rem] h-[30rem] opacity-80 rounded-3xl cursor-pointer bg-gray-100 backdrop-blur-3xl hover:opacity-100 duration-500 shadow-2xl max-lg:hidden">
      ...
      {/* Buscas que cresceram */}
      <div className="relative group w-[22rem] h-[30rem] opacity-80 rounded-3xl cursor-pointer bg-blue-500 bg-opacity-50 backdrop-blur-3xl hover:opacity-100 hover:bg-opacity-80 duration-500 shadow-2xl max-2xl:hidden">
        ...
        />
        <Image src={PhoneSide} alt="Lado de um smartphone" className="absolute bottom-0 right-32" />
        <Image
          src={Lemon}
          alt="Limão"
        ...
        <div className="absolute inset-0 overflow-hidden rounded-3xl">
          <Image
            src={BushBox}
            alt="Arbusto"
            className="absolute -left-24 -bottom-52 group-hover:opacity-100 duration-500 group-hover:rotate-12 group-hover:-translate-y-4"
          />
        </div>
      </div>
    </div>
